...
class TestUserSignUp(unittest.TestCase):
    ...
    def signup_user(self, username, password, email, firstname, lastname, role, confirm_password):
        data = {'username': username, 'password': password, 'email': email, 'firstname': firstname,
                'lastname': lastname, 'role': role, 'confirm_password': confirm_password}
    ...
    def test_user_signup(self):
        ...
        output = self.signup_user(
            'kizza5', 'Test123', 'test5@test.com', 'kizza', 'samuel', 'teacher', 'Test123')
